...
description: Capture a bug report from the QA engineer, format it cleanly with exact location mapping, auto-evaluate severity and tags, ask about related tickets, and publish it to Jira.
---
